...
const generateJanuarySlots = (pattern: string[]) => {
    const slots: { date: string; times: string[] }[] = [];
    for (let day = 1; day <= 31; day++) {
        const date = `2026-01-${day.toString().padStart(2, '0')}`;
        slots.push({ date, times: pattern });
    }
    return slots;
};

const slotPatterns = {
    early: ['06:30', '07:00', '07:30', '08:00', '08:30'],
    standard: ['07:00', '07:30', '08:00', '08:30', '09:00'],
    late: ['08:00', '08:30', '09:00', '09:30'],
    afternoon: ['13:00', '13:30', '14:00', '14:30', '15:00'],
    mixed: ['07:00', '08:00', '14:00', '14:30', '15:00'],
    premium: ['06:30', '07:00', '07:30', '08:00', '14:00', '14:30', '15:00']
};
...
export const golfCourses: GolfCourse[] = [
    {
        ...
        availableSlots: [
            ...
            ...generateJanuarySlots(['07:00', '07:30', '08:00', '08:30', '14:00', '14:30', '15:00'])
        ]
    },
    {
        id: 2,
        ...
        availableSlots: [
            ...
            ...generateJanuarySlots(['06:30', '07:00', '07:30', '08:00', '14:30', '15:00'])
        ]
    },
    {
        id: 3,
        ...
        availableSlots: [
            ...
            ...generateJanuarySlots(['07:30', '08:00', '08:30', '09:00', '14:00', '14:30'])
        ]
    },
    {
        id: 4,
        ...
        availableSlots: [
            ...
            ...generateJanuarySlots(['07:00', '08:00', '08:30', '09:00', '14:00', '15:00'])
        ]
    },
    {
        id: 5,
        ...
        availableSlots: [
            ...
            ...generateJanuarySlots(['07:30', '08:00', '09:00', '14:00', '14:30'])
        ]
    },
    {
        id: 6,
        ...
        availableSlots: [
            ...
            ...generateJanuarySlots(['06:30', '07:30', '08:30', '14:00', '15:00'])
        ]
    },
    {
        id: 7,
        ...
        availableSlots: [
            ...
            ...generateJanuarySlots(['07:00', '08:00', '08:30', '09:00', '14:30', '15:30'])
        ]
    },
    {
        id: 8,
        ...
        availableSlots: [
            ...
            ...generateJanuarySlots(['07:30', '08:30', '09:00', '14:00', '14:30'])
        ]
    },
    {
        id: 9,
        ...
        availableSlots: [
            ...
            ...generateJanuarySlots(['06:30', '07:00', '07:30', '08:00', '14:00', '15:00'])
        ]
    },
    {
        id: 10,
        ...
        availableSlots: [
            ...
            ...generateJanuarySlots(['08:00', '08:30', '09:00', '14:00', '15:00'])
        ]
    },
    {
        id: 11,
        ...
        availableSlots: [
            ...
            ...generateJanuarySlots(['07:00', '07:30', '08:30', '14:00', '15:00'])
        ]
    },
    {
        id: 12,
        ...
        availableSlots: [
            ...
            ...generateJanuarySlots(['07:30', '08:00', '08:30', '14:30', '15:00'])
        ]
    },
    {
        id: 13,
    ...
    },
    {
        ...
        availableSlots: [
            ...
            ...generateJanuarySlots(['07:00', '08:00', '08:30', '14:00', '15:00'])
        ]
    },
    {
        id: 15,
        ...
        availableSlots: [
            ...
            ...generateJanuarySlots(['07:30', '08:30', '09:00', '14:00', '15:00'])
        ]
    },
    {
        id: 16,
        ...
        availableSlots: [
            ...
            ...generateJanuarySlots(['07:00', '08:00', '09:00', '14:00', '15:00'])
        ]
    },
    {
        id: 17,
    ...
    },
    {
        ...
        availableSlots: [
            ...
            { date: '2026-01-01', times: ['07:00', '08:00', '09:00', '14:00', '15:00'] },
            ...generateJanuarySlots(['06:30', '07:30', '09:00', '14:00', '15:00'])
        ]
    },
    {
        id: 27,
